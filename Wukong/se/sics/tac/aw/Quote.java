...
public class Quote {
  ...
  public float getAskPrice() { // returns the last ask price
    return askPrice;
  }
  ...
  public float getBidPrice() { // returns the last bid price
    return bidPrice;
  }
  ...
  public int getHQW() { // returns the current HQW (Hypothetical Quantity Won)
    return hqw;
  }

  public boolean hasHQW(Bid bid) { // returns true if the HQW is valid for the bid 'bid'
  ...
  public int getAuctionStatus() { // returns the auction status
    return status;
  }
  ...
  public long getNextQuoteTime() {
	// returns the next time the quote is updated
	// (less or equal to 0 if not supported or not known)
  ...
  public long getLastQuoteTime() {
	// returns the time for the last quote update (less or equal to 0 if not yet updated)
  ...
  public Bid getBid() { // return the bid that was active when the quote was requested
    return bid;
  }
